...
@export var _coyote_time : float = 0.0
@export var _jump_buffer : float = 0.0
@export var _jumped : bool = false

@export var _jump_velocity : float = ((2.0 * jump_height) / time_to_peak)
